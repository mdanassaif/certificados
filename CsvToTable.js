	        ...
	        for (var singleRow = 0; singleRow < allRows.length; singleRow++) {
	            ...
	            for(var rowCell = 0; rowCell < rowCells.length; rowCell++){
	                if(singleRow === 0){
	                    ...
	                    table += '<td>';
						if (rowCell != 4) {		// verifica se é diferente do 5 campo do arquivo csv
							table += rowCells[rowCell];
						} else {
	                    	table += '<a href="files/';
							table += rowCells[rowCell];
							table += '"><img src="https://img.shields.io/badge/PDF-EC1C24?style=for-the-badge&logo=AdobeAcrobatReader&logoColor=white"></a>';
						}
	                    table += '</td>';
	                }
	            }
